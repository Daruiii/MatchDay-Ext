import { createPath, Link, useMatch, useResolvedPath } from 'react-router-dom'
...
export default function Navbar() {
    ...
    return (
        <nav className="nav">
            <Link to="/popup.html" className='site-title'><img src={ExtLogo} alt="ExtLogo" width="50" /></Link>
            <ul id="link-team">
